                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between mb-3">
                            <div class="mt-2">
                                <h4 class="card-title">Create Reel</h4>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div>
                                    <form action="{{ route('admin.storereel') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    @if ($errors->has('cover_image'))
                                                        <div class=" text-danger text-start">{{ $errors->first('cover_image') }}</div>
                                                    @endif
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    @if ($errors->has('video'))
                                                        <div class=" text-danger text-start">{{ $errors->first('video') }}</div>
                                                    @endif
                                                </div>
                                            </div>
